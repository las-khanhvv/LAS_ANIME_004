...
class AnimeQuoteViewController: BaseViewController {
    ...
    private func bindViewModel() {
        let input = AnimeQuoteViewModel.Input(loadTrigger: rx.viewWillAppear.take(1).asDriverOnErrorJustComplete())
        ...
        nextButton.rx.tap
            ...
            .drive(onNext: { [weak self] _ in
                ...
                print("tapp")
//                if self.kolodaView.isAnimating {
//                    print("animate")
//                    self.kolodaView.pop_removeAllAnimations()
//                    self.kolodaView.sw
//                }
